...
export const metadata = {
  title: 'Technical Posts - Power Systems, GridSpeed, and Smart Grid Tutorials',
  description: 'In-depth technical posts on power systems modeling, GridSpeed simulations, smart grid technologies, and distribution system analysis.',
  alternates: { canonical: '/posts' },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Technical Posts - Power Systems & GridSpeed Tutorials',
    description: 'Expert tutorials and guides on power systems modeling, GridSpeed simulations, and smart grid technologies.',
    type: 'website',
    url: 'https://www.gridspeed.app/posts',
  },
};
    ...
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <header className="mb-12 text-center">
        ...
        <p className="text-[1.3125rem] text-black max-w-3xl mx-auto font-[family-name:var(--font-pt-serif)]">
          In-depth tutorials, guides, and insights on power systems modeling, GridSpeed simulations, 

  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-16">
      ...
      <div className="grid md:grid-cols-3 gap-6 md:gap-8">
        <button onClick={onCreate} className="bg-white rounded-none shadow-sm border border-gray-200 p-8 text-center hover:shadow-lg transition-shadow">
          <div className="mb-6">
            <div className="w-40 h-28 md:w-48 md:h-32 mx-auto bg-blue-50 rounded-none flex items-center justify-center">
        ...
        <button onClick={onLearn} className="bg-white rounded-none shadow-sm border border-gray-200 p-8 text-center hover:shadow-lg transition-shadow">
          <div className="mb-6">
            <div className="w-40 h-28 md:w-48 md:h-32 mx-auto bg-green-50 rounded-none flex items-center justify-center">
        ...
        <button onClick={onClone} className="bg-white rounded-none shadow-sm border border-gray-200 p-8 text-center hover:shadow-lg transition-shadow">
          <div className="mb-6">
            <div className="w-40 h-28 md:w-48 md:h-32 mx-auto bg-purple-50 rounded-none flex items-center justify-center">

...
export default function ProjectsSidebar({ onCreate }) {
  return (
    <div className="w-64 bg-white border-r border-gray-200 flex flex-col">
      <div className="p-4">
        <button onClick={onCreate} className="w-full bg-orange-600 text-white px-4 py-2.5 font-medium hover:bg-orange-700 transition-colors">
          + New project
        </button>
      </div>
      ...
      <nav className="flex-1 px-4">
        ...
        <div className="mt-8">
          ...
          <div className="mt-3 space-y-1">
            <button className="flex items-center w-full px-3 py-2 text-sm hover:bg-gray-100">+ New tag</button>
            <div className="flex items-center px-3 py-2 text-sm hover:bg-gray-100 cursor-pointer">
              <span className="w-3 h-3 bg-orange-500 mr-2"></span>
              power_flow (3)
            </div>
            <div className="flex items-center px-3 py-2 text-sm hover:bg-gray-100 cursor-pointer">
              <span className="w-3 h-3 bg-blue-500 mr-2"></span>
              solar_pv (2)
            </div>
      ...
      <div className="p-4 border-t border-gray-200">
        <div className="text-sm text-gray-600">
          ...
          <button className="px-3 py-1.5 border border-gray-300 hover:bg-gray-50 transition-colors">Add affiliation</button>
        </div>
      </div>
    </div>
  );
